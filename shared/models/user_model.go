...
type UserModel struct {
	...
	Companies                  []CompanyModel     `gorm:"many2many:user_companies;" json:"companies,omitempty"`
	Distributors               []DistributorModel `gorm:"many2many:user_distributors;" json:"distributors,omitempty"`
