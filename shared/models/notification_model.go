...
type NotificationModel struct {
	...
	User          *UserModel        `gorm:"foreignKey:UserID;constraint:OnDelete:CASCADE;-:migration" json:"user,omitempty"`
	MerchantID    *string           `gorm:"type:char(36);index" json:"merchant_id,omitempty"`
	Merchant      *MerchantModel    `gorm:"foreignKey:MerchantID;constraint:OnDelete:CASCADE;-:migration" json:"merchant,omitempty"`
	DistributorID *string           `gorm:"type:char(36);index" json:"distributor_id,omitempty"`
	Distributor   *DistributorModel `gorm:"foreignKey:DistributorID;constraint:OnDelete:CASCADE;-:migration" json:"distributor,omitempty"`
	CompanyID     *string           `gorm:"type:char(36);index" json:"company_id,omitempty"`
	Company       *CompanyModel     `gorm:"foreignKey:CompanyID;constraint:OnDelete:CASCADE;-:migration" json:"company,omitempty"`
