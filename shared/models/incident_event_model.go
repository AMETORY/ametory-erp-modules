...
type IncidentEventModel struct {
	...
	LocationPointID  *string             `gorm:"size:36" json:"warehouse_location_id,omitempty"`
	LocationPoint    *LocationPointModel `gorm:"foreignKey:LocationPointID;constraint:OnDelete:CASCADE" json:"warehouse_location,omitempty"`
	...
	WasteWarehouseID *string             `gorm:"-" json:"waste_warehouse_id,omitempty"`
}
